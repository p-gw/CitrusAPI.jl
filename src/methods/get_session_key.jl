...
function get_session_key(client::LimeSurveyClient, username::AbstractString, password::AbstractString; plugin="Authdb")
...
function connect!(client::LimeSurveyClient, username::String, password::String; plugin="Authdb")
